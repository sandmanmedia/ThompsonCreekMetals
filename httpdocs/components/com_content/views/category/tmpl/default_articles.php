...
<!--====================================================================================================================-->
					...
					?>
						<td headers="categorylist_header_hits" class="">
							<span class="">
								
								<a style="" href="<?php echo JRoute::_(ContentHelperRoute::getArticleRoute($article->slug, $article->catid).$url ); ?>" target="_blank">
									<?php echo JText::sprintf('JGLOBAL_PDF_IMAGE', $article->title);  ?>
								</a>
